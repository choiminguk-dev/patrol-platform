...
JSON 형식으로만 응답:
{"groups":[{"address":"도로명 건물번호","photoIndices":[1,2,3],"photoTimes":{"1":"07:05","2":"07:06","3":null},"description":"현장 상황 한줄 설명","zoneSeqNo":1,"reasoning":"사진 3에서 파란 표지판 '두텁바위로 155' 확인. 사진 1=07:05, 2=07:06 → 갭 1분 → 동일 그룹."}]}
